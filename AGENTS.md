...
Reread the roadmap and, when applicable, the ML maturity and DA-LUC overlays:
...
5. before opening or merging any performance, kernel-selection, weight-representation, KV-format, model-runtime, serving, DA-LUC, PHR-Lite, or ElasticAutoTuner PR.
...
This file is a bootstrap pointer, not the roadmap itself. The off-main sovereignty roadmap plus the applicable ML maturity and DA-LUC overlays are the persistent sources of current agent strategy and research priorities.
