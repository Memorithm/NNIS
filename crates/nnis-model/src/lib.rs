...
pub use elastic_stage_b_handoff::{
    ...
    NNIS_ELASTIC_STAGE_B_CONSUMER, NNIS_ELASTIC_STAGE_B_FINAL_TEST_PARTITION_LOCKED,
    NNIS_ELASTIC_STAGE_B_HANDOFF_VERSION, NNIS_ELASTIC_STAGE_B_PREREGISTRATION_PACKET_VERSION,
};
...
pub use smollm2_weight_qualification_protocol::{
    ...
    NNIS_SMOLLM2_WEIGHT_QUALIFICATION_PROMPT_TEXT,
