...
pub use int4_reference::{
    ...
    Int4DenseMaterializedModelV1, Int4ReferenceAllocationSummaryV1,
    Int4ReferenceModelStorageV1, Int4ReferenceProjectionPlanV1, Int4ReferenceQuantizedTensorV1,
    Int4ReferenceStorageSummaryV1, NNIS_INT4_REFERENCE_ACCUMULATION_V1,
